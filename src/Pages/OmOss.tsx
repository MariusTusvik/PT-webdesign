...
function OmOss() {
  return (
    <body className='bg-[#212121] px-56 py-20'>
      ...
      <div className='flex  gap-20 '>
        ...
        <h5 className='flex text-[#12a8f4] font-bold text-7xl w-3/4 py-20'>
          Cthulu is real and you should come pray with us
        </h5>
      </div>

      <div className='text-[#F746A1] text-4xl font-bold items-end'>
        <h4 className='p-10'>
